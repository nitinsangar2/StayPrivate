 ...
 */
public class BasicOnKeyboardActionListener2 implements OnKeyboardActionListener {
	 ...
	 */
	public BasicOnKeyboardActionListener2(Activity targetActivity) {
				  ...
				  if(editable.length()>=4)
					{
					  ...
					  if(Constants.a==1)
					  {
						  i = new Intent(mTargetActivity.getApplicationContext(),Insider.class);
					  }
					  else
						   i = new Intent(mTargetActivity.getApplicationContext(),Insider1.class);

					    	
					    		if(editable.equals(Constants.s1))
					    			{
					    			mTargetActivity.finish();
					    			mTargetActivity.startActivity(i);
					    			}
					    		else
